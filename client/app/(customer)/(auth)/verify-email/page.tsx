...
const VerifyEmail = () => {
  return (
    <AuthLayout
      imagePanel={
        <div className="relative h-full w-full bg-[url('/assets/auth-6.jpg')] bg-cover bg-center">
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent" />

          <div className="absolute bottom-8 left-8 right-8 text-white">
            <p className="font-serif text-2xl font-medium">Geritcht</p>
            <p className="mt-1 text-sm text-white/80">
              Confirm your email to unlock reservations, online ordering, and a
      ...
      <div className="flex h-full flex-col p-6 md:p-8">
        ...
        <div className="mt-8">
          ...
          <p className="mt-3 max-w-md text-sm leading-6 text-black/60">
            ...
            code below to activate your account and start enjoying everything
            Geritcht has to offer.
          </p>
        </div>
